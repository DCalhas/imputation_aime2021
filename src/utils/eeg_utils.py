...
#			
##########################################################################################################################
def get_eeg_instance_01(individual, task=1, run=1, path_eeg=dataset_path+'/datasets/01/EEG/', preprocessed=True):
...
def get_eeg_instance_02(individual, task=1, run=1, preprocessed=True, path_eeg=dataset_path+'/datasets/02'):
	...
	if(preprocessed):
		path = path_eeg + '/' + task_run + '/EEG_noGA.mat'
	else:
		path = path_eeg + '/' + task_run + '/EEG_noGA.mat'
...
def get_eeg_dataset(number_individuals=16, path_eeg=dataset_path+'/datasets/01/EEG/', preprocessed=True):
	...
	for i in range(number_individuals):
		individuals += [get_individual(i, path_eeg=dataset_path+'/datasets/01/EEG/', preprocessed=True)]
